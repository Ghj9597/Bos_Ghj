...
public class Promotion implements Serializable {
	...
	public String getTitleImg() {
		if (titleImg.startsWith(Constans.BOS_MANAGEMENT)) {
			return titleImg;
		}
		System.out.println(titleImg);
		return Constans.BOS_MANAGEMENT + titleImg;
	}
	...
	public String getDescription() {
		if(description.contains("<img src=\"" + Constans.BOS_MANAGEMENT + "/")){
			//进行判断如果包含则直接return;
			return description;
		}else{
			//判断如果没有包含的话,为他添加上
			return	description.replace("src=\"/bos_management","src=\""+Constans.BOS_MANAGEMENT_URL);
		}
